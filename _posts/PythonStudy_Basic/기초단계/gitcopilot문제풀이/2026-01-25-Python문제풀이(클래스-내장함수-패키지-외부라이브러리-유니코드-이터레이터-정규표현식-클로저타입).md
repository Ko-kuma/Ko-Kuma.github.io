---
layout: post
title: "[Python] Python, 클래스, 내장함수, 패키지, 외부라이브러리, 유니코드, 이터레이터, 정규표현식, 클로저활용 문제"
date: 2026-01-25
categories: [Python_Basic, Quiz]
tags: [Python, 클래스, 내장함수, 패키지, 외부라이브러리, 유니코드, 이터레이터, 정규표현식, 클로저, 초급]
---

## 안내
- 난이도: 입문~초급
- 각 문제는 해당 개념의 핵심을 익힐 수 있도록 구성했습니다.
